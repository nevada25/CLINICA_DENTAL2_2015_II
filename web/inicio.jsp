...
<div class="panel panel-default" style="margin-top: -110px;">
    ...
    <div class="row">
		<div class="btn-group btn-group-justified">
            <div class="btn-group">
                <button type="button" class="btn btn-nav" data-toggle="modal" data-target="#regiscliente">
                    <span class="glyphicon glyphicon-folder-close"></span>
    			    <p>CLIENTES</p>
                </button>
            </div>
            <div class="btn-group">
                <button type="button" class="btn btn-nav" data-toggle="modal" data-target="#mostrarcli">
