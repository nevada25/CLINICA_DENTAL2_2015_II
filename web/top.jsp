  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar" style="padding-right: -10px;">
        <ul class="nav navbar-nav navbar-right" >
            ...
            <li><a href="menulogin.jsp">INICIAR SESSI&Oacute;N</a></li>
      </ul>
    </div>
      </form>
  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="form-horizontal " style=" color: #000000;padding:1.5px;">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control" name="ape_pat" id="apepat" placeholder="APELLIDO PATERNO">
            </div>
            </div>
             <%--separador--%>
            <div class="form-group">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control" name="ape_mat" id="apemat" placeholder="APELLIDO MATERNO">
            </div>
            </div>
             <div class="form-group">
            ...
            <div class="col-sm-7">
             <select class="form-control" name="tipdoc" >
                ...
                Tipo_docDao dao=new Tipo_docDaoImpl();
                    ...
                    for (TipoDoc listar: dao.mostrartipo_doc()) {
                        
                %>
                <option value="<%=listar.getId_tipo_doc()%>"><%=listar.getNombre_tipo_doc()%></option>
             <%}%> 
             </select>
